        ...
        if (questionType === "text") {
            ...
            return (
                <div sx={{ width: "100%" }} className="text-left">
                    <div required={props.required}>{choices}</div>
                    <input
                        type="hidden"
                        name={props.question.questionOrder.toString()}
                        value={checkboxValue}
            ...
            let fileElement = (
                <div className="mb-2">Respondent has not submitted a file</div>
            );
    ...
    return (
        <div className="mx-5 mb-4">
            <div className="text-left fw-bolder">
                <b>
                    Q{props.question.questionOrder}:{" "}
            ...
            <div>{specialQuestionType(props.question.questionType)}</div>
            <br></br>
            <br></br>
        </div>
    );
